...
import numpy as np
from BlackTelperion.analyse import band_ratio
...
def calcBandRatioOcc(rad, **kwds):
    ...
    Args:
        radiance: Radiance data (BlackData instance) to calculate band ratio with.
        **kwds: Keywords can include:

             - num = Numerator of band ratio, as defined by BlackTelperion.analyse.band_ratio. Default is (400,450) nm.
             - den = Denominator of band ratio, as defined by BlackTelperion.analyse.band_ratio. Default is (550,600) nm.
    ...
    Returns:
        A BlackData instance containing the occlusion factor (0-1) for each point.
    """
...
def calcProjectedOcc(self, geom, sunvec, s=3 ):
    ...
    Args:
        geom: a BlackCloud instance describing scene geometry.
